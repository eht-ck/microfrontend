      ...
      >
        <Row className="align-items-center">
          <Col md={6} className="text-center text-md-start p-4">
            <Card.Body>
              <h2 className="font-italic text-success text-center">
                Our Philosophy 🍃
              </h2>
              ...
              <p className="text-black mt-3">
                We believe that the first cup of tea sets the tone for the day,
                and everyone must have access to a good cup of tea every day. We
                achieve this by sourcing our teas from iconic tea estates that
                conform to rigorous certifications for sustainability and fair
                trade, ensuring that each cup you sip is sustainable and
                delicious.
              </p>
            </Card.Body>
          </Col>
